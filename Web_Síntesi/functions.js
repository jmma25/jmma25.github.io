...
function getFileName(input)
{
 ...
 // EL codigo para mi nombre extraido de chatgpt pq no se usar javascript
 window.onload = function() {
   const textElement = document.querySelector('.joanmaiorano');
   const colors = ['gray', '#333333', 'purple']; 
   let colorIndex = 0;
